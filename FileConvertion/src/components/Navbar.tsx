export default function Navbar() {
    return (
        <div className="grid grid-cols-3 p-7">
            ...
            <a className="flex items-center items-justify justify-self-end hover:bg-neutral-400 rounded-full" href="https://github.com/Skennymon/HEICtoJPEG.git/" target="_blank">
